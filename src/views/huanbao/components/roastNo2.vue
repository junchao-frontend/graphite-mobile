  ...
  <div class="roast-no2">
    <div class="cemsTrend">
      <div class="head">
        ...
        <span style="margin-left: 10px">NO2</span>
      </div>
      <div id="NO2"></div>
    </div>
  </div>
  ...
  methods: {
    initNo2Trend() {
        ...
        if (res.data.code === 200) {
          var currentCems = "焙烧CEMS-氮氧化物Zs";
            if (this.currentCode === "130424LRTTS001") {
              currentCems = "焙烧CEMS-氮氧化物Zs";
            } else if (this.currentCode === "130424LRTTS002") {
              currentCems = "隧道窑/浸渍CEMS-氮氧化物Zs";
            }
    ...
    initEcharts () {
      const myChart = this.$echarts.init(document.getElementById('NO2'))
      const option = {
        title: {
